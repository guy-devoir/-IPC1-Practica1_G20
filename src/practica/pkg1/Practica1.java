...
public class Practica1 {
    ...
    private static void leerArchivo() {
        ...
        try {
            ...
            for (int i = 0; i < lineas.length; i++) {
                    ...
                    matrixAux = new double[filaMatriz.length][cantidadColumnas];
    ...
    */
    ...
    public static void reporteMultiplicacionEscalar(double num){
